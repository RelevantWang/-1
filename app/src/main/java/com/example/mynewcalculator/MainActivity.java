...
public class MainActivity extends AppCompatActivity
{
    ...
    private Button btn_point,btn_inverse,btn_equal,btn_bin;
    ...
    private void Init()
    {
        ...
        btn_bin=findViewById(R.id.op_bin_btn);
    ...
    private void BindBtnWithListener()
    {
        ...
        btn_bin.setOnClickListener(new MyOnCilckListener() {
            @Override
            public void onClick(View v) {
                super.onClick(v);
    ...
    {
        if (str.equals("sin(") || str.equals("cos(") || str.equals("tan(") || str.equals("lg(") || str.equals("-(")||str.equals("bin("))
        {
            return "true";
        }
